...
<html lang="en">
  <head>
    <title>Hada Labo + Brightening Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Hada Labo + Brightening Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Hada Labo + Brightening Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Hada Labo + Brightening Mask 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Combines Arbutin, Tranexamic Acid, Vitamin C and other whitening ingredients to help relief visible redness, 
				improve yellowish skin tone and reawaken dull skin, leaving skin perfectly luminous and translucent with natural radiance.
			</p>
			<hr>
            <p><strong class="text-primary h4">RM10.90</strong></p>
