...
<html lang="en">
  <head>
    <title>Laneige Lip Sleeping Mask[Vanilla]</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Laneige Lip Sleeping Mask[Vanilla]</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/lipmask/Laneige Lip Sleeping Mask[Vanilla].jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Laneige Lip Sleeping Mask[Vanilla] 20g</h2>
