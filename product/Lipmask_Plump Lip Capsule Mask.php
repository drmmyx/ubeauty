...
<html lang="en">
  <head>
    <title>Kocostar Plump Lip Capsule Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Kocostar Plump Lip Capsule Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/lipmask/Plump Lip Capsule Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Kocostar Plump Lip Capsule Mask 30pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Unique, travel-friendly all-in-one lip care! Instantly hydrates dry, chapped lips and gradually makes the lips plumper and fuller.
			<hr>
			</p>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM71.90</strong></p>
            <p class="text-primary h4">RM65.00</p>
            <div class="mb-5">
