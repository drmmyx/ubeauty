...
<html lang="en">
  <head>
    <title>Mirae Ex8 Minutes Instant Soothing Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Mirae Ex8 Minutes Instant Soothing Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Mirae Ex8 Minutes Instant Soothing Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Mirae Ex8 Minutes Instant Soothing Mask 5pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Korea latest 8 mins revitalizing water Bionic Technology that effectively deliver oxygen 
				and nutrients deep into every single skin cell in just 8 minutes.
			<hr>
			</p>
