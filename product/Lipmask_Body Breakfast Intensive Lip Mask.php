...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Body Breakfast Intensive Lip Mask</strong></div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              echo
                '<div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <h2 style="font-family:Bernard MT Condensed;" class="text-black">' . $row['product_Name'] . '</h2>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star "></span>
                    <span class="fa fa-star "></span>
			              <p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">' . $row['product_Description'] . '<hr></p>
                    <p><strong class="text-primary h4" style="text-decoration:line-through">' . $row['product_Price'] . '</strong></p>
                    <p class="text-primary h4">RM42.00</p>
                    <div class="mb-5">
          ...
          ?>
          <div class="col-md-6">
            <img src="image/lipmask/Body Breakfast Intensive Lip Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Body Breakfast Intensive Lip Mask 30g</h2>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star "></span>
            ...
            <p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
              There's a lot of natural goodness packed into this Intensive Lip Mask. It hydrates & helps soften your pout.
              <hr>
            </p>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM53.00</strong></p>
            <p class="text-primary h4">RM42.00</p>
            <div class="mb-5">
              <div class="input-group mb-3" style="max-width: 120px;">
                <div class="input-group-prepend">
