...
<html lang="en">
  <head>
    <title>Skin Food Avocado & Olive Lip Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Skin Food Avocado & Olive Lip Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/lipmask/Skin Food Avocado & Olive Lip Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Skin Food Avocado & Olive Lip Mask 12g</h2>
            ...
            <p><strong class="text-primary h4">RM25.90</strong></p>
