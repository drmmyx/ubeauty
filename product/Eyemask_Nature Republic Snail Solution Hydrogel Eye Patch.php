...
<html lang="en">
  <head>
    <title>Nature Republic Aqua Collagen Solution Hydrogel Eye Patch</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Nature Republic Aqua Collagen Solution Hydrogel Eye Patch</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Nature Republic Aqua Collagen Solution Hydrogel Eye Patch.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Nature Republic Aqua Collagen Solution Hydrogel Eye Patch 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				It is an intensive hydrogel mask for eye areas that contains infused marine collagen ingredients extracted from pristine areas.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM9.30</strong></p>
