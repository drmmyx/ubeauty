...
<html lang="en">
  <head>
    <title>Innisfree Jeju Orchid Enriched Cream Mask Set</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">B.liv Hydrating Mask Immerse Me [Utmost Moisture]</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Innisfree Jeju Orchid Enriched Cream Mask Set.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Innisfree Jeju Orchid Enriched Cream Mask Set 5pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Formulated with the key ingredients of Jeju Orchid Enriched Cream for a firm, supple and youtuful-looking skin.
			</p>
			<hr>
            <p><strong class="text-primary h4">RM94.00</strong></p>
