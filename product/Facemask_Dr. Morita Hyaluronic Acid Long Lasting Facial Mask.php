...
<html lang="en">
  <head>
    <title>Dr. Morita Hyaluronic Acid Long Lasting Facial Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Dr. Morita Hyaluronic Acid Long Lasting Facial Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/DrMorita Hyaluronic Acid Long Lasting Facial Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Dr. Morita Hyaluronic Acid Long Lasting Facial Mask 5pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Made from natural silk, this highly hydrating facial mask provides as much as 24 hours of continuous hydration to leave skin dewy soft and hydrated with improved elasticity.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM20.00</strong></p>
