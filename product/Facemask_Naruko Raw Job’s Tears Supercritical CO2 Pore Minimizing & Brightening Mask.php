...
<html lang="en">
  <head>
    <title>Naruko Raw Job’s Tears Supercritical CO2 Pore Minimizing & Brightening Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Naruko Raw Job’s Tears Supercritical CO2 Pore Minimizing & Brightening Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Naruko Raw Job’s Tears Supercritical CO2 Pore Minimizing & Brightening Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Naruko Raw Job’s Tears Supercritical CO2 Pore Minimizing & Brightening Mask 10pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				This functional brightening mask helps brighten and smooth skin, with red and white Job's Tears extracts, 
				Yeast Complex B for sebum-control, pore-minimizing and other brightening ingredients, 
				to balance skin and eliminate melanin, revealing flawlessly bright skin.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM32.00</strong></p>
