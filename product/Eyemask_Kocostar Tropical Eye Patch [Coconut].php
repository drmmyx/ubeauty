...
<html lang="en">
  <head>
    <title>Kocostar Tropical Eye Patch[#Coconut]</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Kocostar Tropical Eye Patch[#Coconut]</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Kocostar Tropical Eye Patch [Coconut].png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Kocostar Tropical Eye Patch 1pcs [#Coconut]</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				KOCOSTAR’s Tropical Eye Patch is made of soft and delicate hydrogel material, which contains natural tropical fruit component that gives the gel a natural fruit color.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM6.90</strong></p>
