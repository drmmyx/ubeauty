...
<html lang="en">
  <head>
    <title>Acelabs Diamond Luminous Intense Brightening Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Acelabs Diamond Luminous Intense Brightening Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Acelabs Diamond Luminous Intense Brightening Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Acelabs Diamond Luminous Intense Brightening Mask 10pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Rejuvenates and illuminates the skin with Diamond. The ultimate brightening solution.
			</p>
			<hr>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM10.90</strong></p>
            <p class="text-primary h4">RM60.00</p>
            <div class="mb-5">
