...
<html lang="en">
  <head>
    <title>Petitfee Gold & Snail Hydrogel Eye Patch</title>
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Petitfee Gold & Snail Hydrogel Eye Patch.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Petitfee Gold & Snail Hydrogel Eye Patch 60pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Make your skin firming, healthy, and glowing complexion.
			<hr>
			</p>
