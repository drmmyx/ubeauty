...
<html lang="en">
  <head>
    <title>Dr.Jart+ Dermask Vital Hydra Solution</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Dr.Jart+ Dermask Vital Hydra Solution</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Dr.Jart+ Dermask Vital Hydra Solution.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Dr.Jart+ Dermask Vital Hydra Solution 5pcs</h2>
			...
			<hr>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM80.00</strong></p>
