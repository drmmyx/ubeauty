...
<html lang="en">
  <head>
    <title>Nature Republic Snail Solution 10,000 Hydrogel Eye Patch</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Nature Republic Snail Solution 10,000 Hydrogel Eye Patch</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Nature Republic Snail Solution 10,000 Hydrogel Eye Patch.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Nature Republic Snail Solution 10,000 Hydrogel Eye Patch 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Nature Republic Snail Solution 10,000 Hydrogel Eye Patch is excellent moisturizing hydro gel type eye patch.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM11.20</strong></p>
