...
<form name="foodmenu">
		...
		<input type="file" name="food_picture"><br><img src="image/A'pieu Real Big Yogurt One-Bottle [Apple].png" style="width:10%;">
		...
		<input type="text" name="food_name" placeholder="Enter product name" value="A'pieu Real Big Yogurt One-Bottle [Apple]" style="width:100%;height:36px;border-radius:5px;border-style:groove;">
		<br><br><label>Product price: <br></label>
		<input type="text" name="food_price" placeholder="RM" value="RM 3.45" style="width:100%;height:36px;border-radius:5px;border-style:groove;">	
		<br><br><label>Product Description:<br></label>
		<textarea name="food_introduction" rows="3" cols="40" placeholder="Description......" style="border-radius:6px;width:100%;border-radius:5px;border-style:groove;">Yogurt extract and Lactobacillus components help strengthen skin barrier, helping to create a firm, healthy skin. L-Cell sheet with high transparency effectively conveying the active ingredient.</textarea>
		<br><br><label>Promotion:</label>
		<input type="radio" name="promotion" value="Y"> Yes
		<input type="radio" name="promotion" value="N" checked> No		
