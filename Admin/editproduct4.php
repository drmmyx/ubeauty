...
<form name="foodmenu">
		...
		<input type="file" name="food_picture"><br><img src="image/Jayjun Eye Gel Patch.png" style="width:10%;">
		...
		<select name="food_category" size="1" style="width:100%;border-radius:5px;border-style:groove;height:30px;">
			...
			<option value="Eyemask" selected>Eyemask</option>
			<option value="Lipmask">Lipmask</option>
		</select>
		<br><br><label>Product Name: <br></label>
		<input type="text" name="food_name" placeholder="Enter product name" value="Jayjun Eye Gel Patch" style="width:100%;height:36px;border-radius:5px;border-style:groove;">
		<br><br><label>Product price: <br></label>
		<input type="text" name="food_price" placeholder="RM" value="RM 80.00" style="width:100%;height:36px;border-radius:5px;border-style:groove;">	
		<br><br><label>Product Description:<br></label>
		<textarea name="food_introduction" rows="3" cols="40" placeholder="Description......" style="border-radius:6px;width:100%;border-radius:5px;border-style:groove;">It is a hydrogel that soothes irritated skin with green tea powder and it also protects and strengthens delicate skin around the eyes.</textarea>
