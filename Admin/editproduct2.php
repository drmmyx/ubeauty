...
<form name="foodmenu">
		...
		<input type="file" name="food_picture"><br><img src="image/Laneige Lip Sleeping Mask[Berry].jpg" style="width:10%;">
		...
		<select name="food_category" size="1" style="width:100%;border-radius:5px;border-style:groove;height:30px;">
			...
			<option value="Lipmask" selected>Lipmask</option>
		</select>
		<br><br><label>Product Name: <br></label>
		<input type="text" name="food_name" placeholder="Enter product name" value="Laneige Lip Sleeping Mask[Berry]" style="width:100%;height:36px;border-radius:5px;border-style:groove;">
		<br><br><label>Product price: <br></label>
		<input type="text" name="food_price" placeholder="RM" value="RM 65.00" style="width:100%;height:36px;border-radius:5px;border-style:groove;">	
		<br><br><label>Product Description:<br></label>
		<textarea name="food_introduction" rows="3" cols="40" placeholder="Description......" style="border-radius:6px;width:100%;border-radius:5px;border-style:groove;">The New Lip Sleeping Mask gently melts dead skin cells and makes the lips feel smooth and elastic during sleep.</textarea>
