...
<html lang="en">
  <head>
    <title>Naruko Rose & Botanic HA Aqua Cubic Hydrating Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Naruko Rose & Botanic HA Aqua Cubic Hydrating Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Naruko Rose & Botanic HA Aqua Cubic Hydrating Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Naruko Rose & Botanic HA Aqua Cubic Hydrating Mask 10pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				This amazing mask contains active concentrates. It provides intense hydration and replenishes the skin with abundant moisture, helping dull, tired-looking skin to restore its dewy, radiant glow.
			<hr>
			</p>
