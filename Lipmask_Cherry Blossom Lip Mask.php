...
<html lang="en">
  <head>
    <title>Cherry Blossom Lip Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Cherry Blossom Lip Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/lipmask/CHERRY BLOSSOM LIP MASK.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Cherry Blossom Lip Mask 1's</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Take out the patch and place it on clean lips. Chill for 20 minutes. Discard the patch and pat in any excess essence. Alternatively try applying to nipples, nicks from shaving, and elbows for soothing and moisture boost.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM9.90</strong></p>
