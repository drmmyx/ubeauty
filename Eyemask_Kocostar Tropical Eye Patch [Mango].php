...
<html lang="en">
  <head>
    <title>Kocostar Tropical Eye Patch[#Mango]</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Kocostar Tropical Eye Patch[#Mango]</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Kocostar Tropical Eye Patch [Mango].png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Kocostar Tropical Eye Patch 1pcs [#Mango]</h2>
