...
<html lang="en">
  <head>
    <title>Klavuu Green Pearlsation Tea Tree Care Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Klavuu Green Pearlsation Tea Tree Care Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Klavuu Green Pearlsation Tea Tree Care Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Klavuu Green Pearlsation Tea Tree Care Mask 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				A relaxing mask sheet soothes and controls skin from excessive sebum by tea tree and marine complex ingredients. 
				It helps to detoxify, soothe and balance the skin for optimal skin health.
			</p>
			<hr>
            <p><strong class="text-primary h4">RM15.90</strong></p>
