...
<html lang="en">
  <head>
    <title>Laneige Lip Sleeping Mask[Berry]</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Laneige Lip Sleeping Mask[Berry]</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/lipmask/Laneige Lip Sleeping Mask[Berry].jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Laneige Lip Sleeping Mask[Berry] 20g</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				The New Lip Sleeping Mask gently melts dead skin cells and makes the lips feel smooth and elastic during sleep.
			<hr>
			</p>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM75.00</strong></p>
