...
<html lang="en">
  <head>
    <title>Klairs Rich Moist Soothing Tencel Sheet Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Klairs Rich Moist Soothing Tencel Sheet Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Klairs Rich Moist Soothing Tencel Sheet Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Klairs Rich Moist Soothing Tencel Sheet Mask 5pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Finally, the most loved KLAIRS Sheet mask is upgraded!
				The Klairs Rich Moist Soothing Tencel Sheet Mask consists of ceramides to enhance skin barriers.
			</p>
			<hr>
            <p><strong class="text-primary h4">RM79.00</strong></p>
