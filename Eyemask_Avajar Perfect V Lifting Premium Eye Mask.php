...
<html lang="en">
  <head>
    <title>Avajar Perfect V Lifting Premium Eye Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Avajar Perfect V Lifting Premium Eye Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Avajar Perfect V Lifting Premium Eye Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Avajar Perfect V Lifting Premium Eye Mask 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Are you still just sticking on patches? Now you can stretch and pull ~
			<hr>
			</p>
            <p><strong class="text-primary h4">RM36.00</strong></p>
