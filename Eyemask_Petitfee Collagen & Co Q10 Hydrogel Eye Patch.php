...
<html lang="en">
  <head>
    <title>Petitfee Collagen & Co Q10 Hydrogel Eye Patch</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Petitfee Collagen & Co Q10 Hydrogel Eye Patch</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Petitfee Collagen & Co Q10 Hydrogel Eye Patch.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Petitfee Collagen & Co Q10 Hydrogel Eye Patch 60pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				98% Hydro Gel Collagen & CoQ10 Hydrogel Eye Patch are infused with extracts of natural flower plants.
			<hr>
			</p>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM74.00</strong></p>
            <p class="text-primary h4">RM69.00</p>
            <div class="mb-5">
