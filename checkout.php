              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>Klavuu Nourishing Care Lip Sleeping Mask <strong class="mx-2">x</strong> 1</td>
                        <td>RM47.00</td>
                      </tr>
                      <tr>
                        <td>Dr.Jart+ Dermask Soothing Hydra Solution <strong class="mx-2">x</strong>   1</td>
                        <td>RM55.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
                        <td class="text-black">RM102.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>RM102.00</strong></td>
                      </tr>
                    </tbody>
                  </table>
