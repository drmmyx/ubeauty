...
<html lang="en">
  <head>
    <title>Almighty Three-way Lifting & Whitening Eye Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Almighty Three-way Lifting & Whitening Eye Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/ALMIGHTY THREE-WAY LIFTING & WHITENING EYE MASK.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Almighty Three-way Lifting & Whitening Eye Mask 6 pairs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				 Effectively moisturizes and firms skin around the eye skin so it appears supple and white.
			<hr>
			</p>
