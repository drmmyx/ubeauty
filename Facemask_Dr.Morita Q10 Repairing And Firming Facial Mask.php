...
<html lang="en">
  <head>
    <title>Dr.Morita Q10 Repairing And Firming Facial Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Dr.Morita Q10 Repairing And Firming Facial Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Dr.Morita Q10 Repairing And Firming Facial Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Dr.Morita Q10 Repairing And Firming Facial Mask 5pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Lightens uneven skin and minimizes the appearance of lines and wrinkles.
			<hr>
			</p>
