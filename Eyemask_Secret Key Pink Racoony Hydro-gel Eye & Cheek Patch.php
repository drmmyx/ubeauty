...
<html lang="en">
  <head>
    <title>Secret Key Pink Racoony Hydro-gel Eye & Cheek Patch</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Secret Key Pink Racoony Hydro-gel Eye & Cheek Patch</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Secret Key Pink Racoony Hydro-gel Eye & Cheek Patch.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Secret Key Pink Racoony Hydro-gel Eye & Cheek Patch 60 sheets</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Pink heart shaped patch contains rose extract. It will help hydrate eyes and cheeks.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM76.90</strong></p>
