        ...
        <div class="row mb-5">
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
              ...
              $condition = "SELECT * FROM `product` where product_isDeleted = 0 ";
              //$conditionA = "";
              ...
              // if (isset($_POST['lip'])) {
              //   $conditionA = "AND category_ID=1";

              //   if (isset($_POST['search'])) {
              //     if (strlen($a)) {
              //       $sql = " AND product_Price >= 0 AND product_Price < 10";
              //       $conditionA = $conditionA . $sql;
              //     } elseif (strlen($b)) {
              //       $sql = " AND product_Price >= 10 AND product_Price < 20";
              //       $conditionA = $conditionA . $sql;
              //     } elseif (strlen($c)) {
              ...
              //   }
              //   if (isset($_POST['l_h'])) {
              //     $ssql = " ORDER BY product_Price ASC ";
              //     $conditionA = $conditionA . $ssql;
              //   }
              //   if (isset($_POST['h_l'])) {
              //     $ssql = " ORDER BY product_Price DESC ";
              //     $conditionA = $conditionA . $ssql;
              //   }
              // }

              // if (isset($_POST['face'])) {
              //   $conditionA = " AND category_ID=2 ";
              ...
              // if (strlen($category_ID) > 0 || strlen($price_MIN) > 0 || strlen($price_MAX) > 0) {
              //   if (strlen($category_ID) > 0) {
              //     $conditionQuery = $conditionQuery . "category_ID= $category_ID ";
              //   }
              // echo 'test min--' . $price_MIN;
              // echo 'test max--' . $price_MAX;
              // if (strlen($price_MIN) > 0) {
              //   echo 'hi min price';
              //   if (strlen($conditionQuery) > 7) {
              //     $conditionQuery =  $conditionQuery . "AND ";
              //   }
              //   $min = doubleval($price_MIN);
              //   $conditionQuery = $conditionQuery . "product_Price > $price_MIN ";
              // }
              ...
              //     $conditionQuery =  $conditionQuery . "AND ";
              //   }
              //   $conditionQuery = $conditionQuery . "product_Price < $price_MAX ";
              // }
              // }

              // if (strlen($conditionQuery) > 7) {
              //   $sql =  $sql . $conditionQuery;
              // }
              /**
               * filter section end
               */
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <form method="post">
                  <li class="mb-1">
                    <a href="shop.php?category_ID=3" class="d-flex">
                      <span>Eye</span>
                      <span class="text-black ml-auto">(24)</span>
                    </a>
                  </li>
                  <li class="mb-1">
                    <a href="shop.php?category_ID=1" class="d-flex">
                      <span>Lips</span>
                      <span class="text-black ml-auto">(12)</span>
                    </a>
                  </li>
                  <li class="mb-1">
                    <a href="shop.php?category_ID=2" class="d-flex">
                      <span>Face</span>
