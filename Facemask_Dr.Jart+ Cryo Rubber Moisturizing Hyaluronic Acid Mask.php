...
<html lang="en">
  <head>
    <title>Dr.Jart+ Cryo Rubber Moisturizing Hyaluronic Acid Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Dr.Jart+ Cryo Rubber Moisturizing Hyaluronic Acid Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Dr.Jart+ Cryo Rubber Moisturizing Hyaluronic Acid Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Dr.Jart+ Cryo Rubber Moisturizing Hyaluronic Acid Mask 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				An intensive moisturizing kit with a cooling and moisture-lock-in 
				rubber mask that boosts the absorption of the hyaluronic acid ampoule.
			</p>
			<hr>
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM54.80</strong></p>
            <p class="text-primary h4">RM49.00</p>
            <div class="mb-5">
