...
<html lang="en">
  <head>
    <title>Au Fairy Bye-Bye, Panda Eyes! Anti-Wrinkle Brightening Eye Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Au Fairy Bye-Bye, Panda Eyes! Anti-Wrinkle Brightening Eye Mask</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Au Fairy Bye-Bye, Panda Eyes! Anti-Wrinkle Brightening Eye Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Au Fairy Bye-Bye, Panda Eyes! Anti-Wrinkle Brightening Eye Mask 10pcs</h2>
            <span class="fa fa-star checked"></span>
			<span class="fa fa-star checked"></span>
			<span class="fa fa-star checked"></span>
			<span class="fa fa-star "></span>
			<span class="fa fa-star"></span>
			<p style="font-size:18px;font-family:Eras Medium ITC;" class="mb-4">
			Pandas are cute but dark circles are not! This eye mask is formulated to reduce the appearance of dark circles and wrinkles around the delicate eye area.	
			</p>
			
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM49.00</strong></p>
			<p class="text-primary h4">RM35.00</p>
			<div class="mb-1 d-flex">
              <label for="option-sm" class="d-flex mr-3 mb-3">
                <span class="d-inline-block mr-2" style="top:-2px; position: relative;"><input type="radio" id="option-sm" name="shop-sizes"></span> <span class="d-inline-block text-black">[#Snail]</span>
              </label>
              <label for="option-md" class="d-flex mr-3 mb-3">
                <span class="d-inline-block mr-2" style="top:-2px; position: relative;"><input type="radio" id="option-md" name="shop-sizes"></span> <span class="d-inline-block text-black">[#Collagen]</span>
              </label>
            </div>
            <div class="mb-5">
            ...
            <p><a href="cart.php" class="buy-now btn btn-sm btn-primary">Add To Cart</a>
			<th><a href="wishlist.php" class="buy-now btn btn-sm btn-outline-primary"><i class="fa fa-heart-o" ></i> Wishlist</a></th></p>
          </div>
        </div>
      </div>
    </div>
