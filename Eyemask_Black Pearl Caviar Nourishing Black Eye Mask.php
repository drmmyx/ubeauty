...
<html lang="en">
  <head>
    <title>Black Pearl Caviar Nourishing Black Eye Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Black Pearl Caviar Nourishing Black Eye Mask</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/BLACK PEARL CAVIAR NOURISHING BLACK EYE MASK.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Black Pearl Caviar Nourishing Black Eye Mask 6's</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Infused with precious Black Pearl & Caviar Extract which helps to reduce the appearance of dark circles, fine lines and puffines. It leaves your eyes looking bright, shiny and refreshed with youthfulness.
			<hr>
			</p>
