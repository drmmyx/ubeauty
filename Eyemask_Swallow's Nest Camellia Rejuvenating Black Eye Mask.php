...
<html lang="en">
  <head>
    <title>Swallow's Nest Camellia Rejuvenating Black Eye Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Swallow's Nest Camellia Rejuvenating Black Eye Mask</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/SWALLOW'S NEST CAMELLIA REJUVENATING BLACK EYE MASK.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Swallow's Nest Camellia Rejuvenating Black Eye Mask 6's</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				Infused with precious swallow 's nest which contains rich protein, polysaccharides and a variety of minerals as the main ingredient for deep moisturizing and brightening. It leaves your eyes looking bright, shiny and refreshed with youthfulness.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM47.90</strong></p>
