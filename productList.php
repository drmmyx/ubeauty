        ...
        <div class="row mb-5">
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
              ...
              $sql = "SELECT * FROM `product` where category_ID = $category_ID LIMIT $pageSize OFFSET $offset";
              ...
              if ($result->num_rows > 0) {
                ...
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="product.php?product_ID=' . $row['product_ID'] . '"><img src="' . $row['product_Image'] . '" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
