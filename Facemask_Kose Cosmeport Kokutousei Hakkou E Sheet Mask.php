...
<html lang="en">
  <head>
    <title>Kose Cosmeport Kokutousei Hakkou E Sheet Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Kose Cosmeport Kokutousei Hakkou E Sheet Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/Kose Cosmeport Kokutousei Hakkou E Sheet Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Kose Cosmeport Kokutousei Hakkou E Sheet Mask 4pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				An extreme moisturizing gel mask that contains highly concentrated fermented black sugar extract, 
				which solves pore issues and dull dry skin.
			</p>
			<hr>
            <p><strong class="text-primary h4">RM52.90</strong></p>
