...
<html lang="en">
  <head>
    <title>A'pieu Real Big Yogurt One-Bottle [Apple]</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">A'pieu Real Big Yogurt One-Bottle [Apple]</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/A'pieu Real Big Yogurt One-Bottle [Apple].png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">A'pieu Real Big Yogurt One-Bottle [Apple] 1pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				...
				L-Cell sheet with high transparency effectively conveying the active ingredient.<hr>
			</p>
            <p><strong class="text-primary h4">RM3.45</strong></p>
