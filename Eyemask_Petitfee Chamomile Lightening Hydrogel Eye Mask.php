...
<html lang="en">
  <head>
    <title>Petitfee Chamomile Lightening Hydrogel Eye Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Petitfee Chamomile Lightening Hydrogel Eye Mask</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/eyemask/Petitfee Chamomile Lightening Hydrogel Eye Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Petitfee Chamomile Lightening Hydrogel Eye Mask 60pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				These hydrogel eye patches are formulated with the Yellow Complex which includes extracts from chamomile, 
				yuzu, pumpkin and more to soothe, revitalize and brighten the eye area.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM93.00</strong></p>
