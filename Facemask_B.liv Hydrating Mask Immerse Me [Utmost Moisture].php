...
<html lang="en">
  <head>
    <title>B.liv Hydrating Mask Immerse Me [Utmost Moisture]</title>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">B.liv Hydrating Mask Immerse Me [Utmost Moisture] 4pcs</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				This moisturizing mask engages lavish boost of hydration that replenishes and sustains!
			</p>
			<hr>
            <p><strong class="text-primary h4">RM29.00</strong></p>
