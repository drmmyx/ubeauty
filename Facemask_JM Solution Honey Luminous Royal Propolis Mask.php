...
<html lang="en">
  <head>
    <title>JM Solution Honey Luminous Royal Propolis Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">JM Solution Honey Luminous Royal Propolis Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/facemask/JM Solution Honey Luminous Royal Propolis Mask.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">JM Solution Honey Luminous Royal Propolis Mask 10pcs</h2>
            ...
            <p><strong class="text-primary h4" style="text-decoration:line-through">RM89.00</strong></p>
			<p class="text-primary h4">RM75.00</p>
