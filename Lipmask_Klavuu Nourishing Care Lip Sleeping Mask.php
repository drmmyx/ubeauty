...
<html lang="en">
  <head>
    <title>Klavuu Nourishing Care Lip Sleeping Mask</title>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Klavuu Nourishing Care Lip Sleeping Mask</strong></div>
		</div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="image/lipmask/Klavuu Nourishing Care Lip Sleeping Pack.png" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 style="font-family:Bernard MT Condensed;" class="text-black">Klavuu Nourishing Care Lip Sleeping Mask</h2>
			...
			<p style="font-size:21px;font-family:Eras Medium ITC;" class="mb-4">
				A sleeping mask for lips creates skin barrier to prevent dehydration while smoothing out dead skin cells.
			<hr>
			</p>
            <p><strong class="text-primary h4">RM47.00</strong></p>
